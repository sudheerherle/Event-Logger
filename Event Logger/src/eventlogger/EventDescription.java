...
public enum EventDescription {
    ...
    EVENT_VRPR2_BOARD_MISSING(19),
    EVENT_MODEM_BOARD_B_FOUND(20),
    EVENT_VRPR1_BOARD_MISSING(21),
    ...
    EVENT_VITAL_RELAY_1_FAILURE(67),
    EVENT_VITAL_RELAY_A_NORMAL(68),
    EVENT_VITAL_RELAY_2_FAILURE(69),
    EVENT_VITAL_RELAY_B_NORMAL(70),
    EVENT_PREPARATORY_RELAY_2_FAILURE(71),
    EVENT_PREPARATORY_RELAY_1_NORMAL(72),
    EVENT_MODEM_A_ERROR(73),
    EVENT_MODEM_A_NORMAL(74),
    EVENT_MODEM_B_ERROR(75),
    EVENT_MODEM_B_NORMAL(76),
    EVENT_FAILURE_AT_US(77),
    EVENT_US_DAC_NORMAL(78),
    EVENT_FAILURE_AT_DS(79),
    EVENT_DS_DAC_NORMAL(80),
    EVENT_TRANSIENT_POWER_FAILURE_AT_US1(81),
    EVENT_US1_POWER_RESTORED(82),
    EVENT_TRANSIENT_POWER_FAILURE_AT_US2(83),
    EVENT_US2_POWER_RESTORED(84),
    EVENT_TRANSIENT_POWER_FAILURE_AT_DS1(85),
    EVENT_DS1_POWER_RESTORED(86),
    EVENT_TRANSIENT_POWER_FAILURE_AT_DS2(87),
    ...
    EVENT_PREPARATORY_RELAY_1_FAILURE(94),

 ...
 *  Author : I14746
 */
public class TableColumnAdjustment implements PropertyChangeListener, TableModelListener
{
	 ...
	 */
	public TableColumnAdjustment(JTable table)
	{
		this(table, 6);
	}
	 ...
	 */
	public TableColumnAdjustment(JTable table, int spacing)
	{
		this.table = table;

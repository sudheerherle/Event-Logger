...
//        com4.setEnabled(false);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(eventlogger.EventLoggerApp.class).getContext().getResourceMap(communicationSetting.class);
    ...
    private void BtnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnConnectActionPerformed
      ...
      Thread te = new Thread(new Runnable() {
        ...
        public void run()
        {
           ...
           if(usb.isSelected() &&  EventLoggerApp.getApplication().getView().com_connect()){
            LblStatus.setText("CONNECTED!");
            BtnConnect.setText("Disconnect");
            LblStatus.setForeground(Color.BLUE);
                try {
               ...
               if(EventLoggerApp.getApplication().getView().com_disconnect()){
